...
import {noFunctionRule} from "../../src/rules/no-function.rule.js";
...
import {noProjectionRule} from "../../src/rules/no-projection.rule.js";
...
describe("rules", () => {
  ...
  // describe("noFunctionRule", () => {
  //   it("emit diagnostics if using function", async () => {
  //     const ruleTester = createLinterRuleTester(runner, noFunctionRule, "ebus");
  //     await ruleTester.expect(`extern fn test();`).toEmitDiagnostics({
  //       code: "ebus/no-function",
  //       message: "Function shouldn't be used with this library.",
  //     });
  //   });
  // });
  ...
  // describe("noProjectionRule", () => {
  //   it("emit diagnostics if using projection", async () => {
  //     const ruleTester = createLinterRuleTester(runner, noProjectionRule, "ebus");
  //     await ruleTester.expect(`model x {};projection x#wire {to: "y"}`).toEmitDiagnostics({
  //       code: "ebus/no-projection",
  //       message: "Projection shouldn't be used with this library.",
  //     });
  //   });
  // });
